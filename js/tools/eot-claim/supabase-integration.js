/**
 * EOT Claim — Supabase Integration
 *
...
export function initEotClaimSupabaseIntegration(mountTool) {
  return initProjectDocumentIntegration({
    mountTool,
    documentType: 'eot_claim',
    recordLabel: 'EOT Claim',
    numberFieldId: 'eotNumber',
  });
}
