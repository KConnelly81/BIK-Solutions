/**
 * Payment Reminder — Supabase Integration
 *
...
export function initPaymentReminderSupabaseIntegration(mountTool) {
  return initProjectDocumentIntegration({
    mountTool,
    documentType: 'payment_reminder',
    recordLabel: 'Payment Reminder',
    numberFieldId: 'reminderNumber',
  });
}
